...
Простое и удобное приложение для управления задачами с сохранением на сервере и в `localStorage`, а также с адаптивным дизайном, который обеспечивает комфортную работу на любых устройствах
